...
Après la détection de structures partielles, nous nous sommes attachés à la détection et à l'évaluation de partition complète.
...
Autant que d'étudier la détection de communautés, les travaux de cette thèse permettent surtout de mieux définir le problème.
...
Le choix du formalisme influence la définition même d'une communauté.
...
\hspace*{1.4em} Afin de mener ces travaux liant théorie et application, nous avons constamment voulu de partager les résultats obtenus: les données récoltées, la théorie proposée et l'implémentation développée.
