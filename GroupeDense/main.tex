...
Il existe également des méthodes identifiant la partie la plus dense d'un réseau.
...
Ainsi même si la méthode permet de détecter un groupe de n\oe{}uds sur des intervalles de temps, elle évalue un candidat sur un graphe agrégé pour appliquer une métrique de graphe.
...
Au final, nous calculons pour chaque voisinage les valeurs de densités des sous-flots voisins.
...
De plus, notre méthode n'identifie pas des ensembles de n\oe{}uds et des intervalles de temps mais des ensembles de liens.
...
Nous utilisons l'algorithme de Louvain qui permet d'identifier des partitions de n\oe{}uds dans un graphe.
