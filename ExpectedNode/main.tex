...
Ensuite dans nos tests dans les graphes généré par LFR, il semble que cette méthode reste bloquée sur des optimum locaux bien plus faibles que la vérité de terrain, voir la figure~\ref{} où la qualité de la partition trouvée par notre algorithme, noté $EN$, est présenté.
...
voir la figure~\ref{} où les partitions $TA+$ et $TB+$ sont les versions améliorées de $TA$ et $TB$.
\begin{figure}
\centering
	\begin{subfigure}{0.31\textwidth}
%		\includegraphics[width=\linewidth]{img/ExpectedNodes/LF/LFR1_EN_ALL.eps}
	...
	$TA$ et $TB$ sont les vérités de terrains, $EN$ est la partition trouvée par notre algorithme et enfin $TA+$ et $TB+$ sont les versions améliorées de $TA$ et $TB$.
	}
	\label{fig:LF_bis_EN}
\end{figure}
