...
\subsection{Cas de deux cliques chevauchentes}
...
La première est la partition triviale où tout les liens sont dans un unique groupe.
Nous définissons également cinq autres partitions qui contiennent 2, 3 ou cinq groupes.
...
\centering
	...
	En (B), taxonomie des n\oe uds du graphes.
...
La principale différence entre ces deux fonctions de qualité est la proportion de chevauchement à partir duquel la meilleur partition change.
